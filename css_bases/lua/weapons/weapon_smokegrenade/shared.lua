...
if ( SERVER ) then
	...
	if ( !util.IsValidModel( "models/weapons/v_eq_smokegrenade.mdl" ) ) then
...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "#Cstrike_WPNHUD_Smoke_Grenade"
	SWEP.Author				= "VALVe"
	SWEP.Slot				= 3
	SWEP.SlotPos			= 1
	...
	killicon.AddFont( "sent_smokegrenade", "CSKillIcons", SWEP.weapon.character:lower(), Color( 255, 80, 0, 255 ) )
...
SWEP.Primary.AmmoType		= "sent_smokegrenade"
