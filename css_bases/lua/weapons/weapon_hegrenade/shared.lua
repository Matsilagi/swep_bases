...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "#Cstrike_WPNHUD_HE_Grenade"
	SWEP.Author				= "VALVe"
	SWEP.Slot				= 3
	SWEP.SlotPos			= 1
	...
	SWEP.weapon				= {}
	SWEP.weapon.character	= "H"

	SWEP.ammo				= {}
	SWEP.ammo.font			= "CSTypeDeath"
	SWEP.ammo.character		= "O"

	killicon.AddFont( "sent_hegrenade", "CSKillIcons", SWEP.weapon.character:lower(), Color( 255, 80, 0, 255 ) )
...
SWEP.Primary.AmmoType		= "sent_hegrenade"
