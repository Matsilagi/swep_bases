...
if ( SERVER ) then
	...
	if ( !util.IsValidModel( "models/weapons/v_smg_mac10.mdl" ) ) then
...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "#Cstrike_WPNHUD_MAC10"
